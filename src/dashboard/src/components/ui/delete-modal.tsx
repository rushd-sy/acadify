...
export default function DeleteMoadl({
  open,
      ...
      <div className="w-[400px] rounded-xl bg-white p-6 shadow-lg">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isLoading}
            className="flex min-w[80px] items-center justify-center rounded-lg bg-red-500 px-4 py-2 text-white hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed"
          >
